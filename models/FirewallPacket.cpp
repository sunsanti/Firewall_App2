...
FirewallPacket::FirewallPacket(int id, QString srcIp, QString desIp, int srcPort, int desPort, int protocol, QString payload)
    : m_id(id), m_srcIp(srcIp), m_desIp(desIp), m_srcPort(srcPort), m_desPort(desPort), m_protocol(protocol), m_payload(payload) {}
FirewallPacket::FirewallPacket(QString srcIp, QString desIp, int srcPort, int desPort, int protocol, QString payload)
...
int FirewallPacket::protocol() const { return m_protocol; }
